...
/*   Updated: 2018/04/03 18:45:56 by fmessina         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ui_obj_update_diff_map(t_env *e, t_object *obj)
{
	gtk_spin_button_set_value(\
						...
						(gdouble)obj->diff_map_size.x);
	gtk_spin_button_set_value(\
						(GtkSpinButton*)e->ui->obj_texture_diff_offset_spin_y, \
						(gdouble)obj->diff_map_size.y);
	gtk_spin_button_set_value(\
						(GtkSpinButton*)e->ui->obj_texture_diff_ratio_spin, \
						(gdouble)obj->diff_map_size.z);
