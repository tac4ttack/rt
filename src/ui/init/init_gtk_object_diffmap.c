...
/*   Updated: 2018/04/03 19:28:11 by fmessina         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_gtk_object_diffmap(t_env *e)
{
	...
	e->ui->obj_texture_diff_ratio_spin_x = GTK_WIDGET(gtk_builder_get_object(\
	e->ui->builder, "obj_texture_diff_ratio_spin_x"));
	e->ui->obj_texture_diff_ratio_spin_y = GTK_WIDGET(gtk_builder_get_object(\
	e->ui->builder, "obj_texture_diff_ratio_spin_y"));
