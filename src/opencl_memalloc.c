...
/*   Updated: 2018/03/05 17:04:37 by fmessina         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			opencl_allocate_obj_memory(t_env *e)
{
	...
	ft_putendl("\x1b[1;32mOpenCL CONES buffer created!\x1b[0m");
	if (NCYL > 0)
...
int			opencl_allocate_scene_memory(t_env *e)
{
	...
	if (!(e->scene_mem = clCreateBuffer(e->context, CL_MEM_READ_ONLY | \
		...
		return (opencl_builderrors(e, 7, e->err));
	ft_putendl("\x1b[1;32mOpenCL SCENE buffer created!\x1b[0m");
	ft_putendl("\x1b[1;32mAll OpenCL memory buffers created!\x1b[0m");
	return (0);
}
